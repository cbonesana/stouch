...
public class EarthquakeProvider extends ContentProvider {
	...
	// Allocate the UriMatcher object, where a URI ending in ‘earthquakes’ will correspond to a request for all earthquakes, and ‘earthquakes’ with a trailing ‘/[rowID]’ will represent a single earthquake row.
	static {
		...
		uriMatcher.addURI("com.example.earthquakeprovider",	SearchManager.SUGGEST_URI_PATH_QUERY, SEARCH);
		uriMatcher.addURI("com.example.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_QUERY + "/*", SEARCH);
		uriMatcher.addURI("com.example.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_SHORTCUT, SEARCH);
		uriMatcher.addURI("com.example.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_SHORTCUT + "/*", SEARCH);
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		...
		case QUAKE_ID:
			...
			count = database.delete(
					EarthquakeDatabaseHelper.EARTHQUAKE_TABLE, KEY_ID + "=" + segment + 
	...
	public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
		...
		case QUAKE_ID:
			...
			count = database.update(EarthquakeDatabaseHelper.EARTHQUAKE_TABLE, values, 
					KEY_ID + "=" + segment + (!TextUtils.isEmpty(where) ? " AND (" + where + ")" : ""), whereArgs);
			break;
		default:
			throw new IllegalArgumentException("Unsupported URI: " + uri);
		}
	...
	public Cursor query(Uri uri, String[] projection, String selection,	String[] selectionArgs, String sortOrder) {
		...
		// Register the contexts ContentResolvr to be notified if the cursor result set changes
